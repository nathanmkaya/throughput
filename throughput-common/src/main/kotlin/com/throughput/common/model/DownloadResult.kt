...
/**
 * Result of a download operation containing timing information
 */
@Serializable
data class DownloadResult(
    ...
    /**
     * Get a human-readable summary of the download result
     */
    fun toSummaryString(): String {
        return "Download: ${ByteUtils.formatBytes(sizeBytes)} in ${duration}, " +
